 ...
 * 
 * @see sig.icom.userservice.db.dao.User
...
public class UserDAO implements IUserDAO {
	...
	public List<User> findByToken(Object token, int... rowStartIdxAndCount) {
		return findByProperty(TOKEN, token, rowStartIdxAndCount);
	}

	public List<User> findByIsLockOut(Object isLockOut,
			int... rowStartIdxAndCount) {
		return findByProperty(IS_LOCK_OUT, isLockOut, rowStartIdxAndCount);
	}
	...
	public List<User> findByPoint(Object point, int... rowStartIdxAndCount) {
		return findByProperty(POINT, point, rowStartIdxAndCount);
	}

	public List<User> findByType(Object type, int... rowStartIdxAndCount) {
		return findByProperty(TYPE, type, rowStartIdxAndCount);
	}

	public List<User> findByLastLon(Object lastLon, int... rowStartIdxAndCount) {
		return findByProperty(LAST_LON, lastLon, rowStartIdxAndCount);
	}

	public List<User> findByLastLat(Object lastLat, int... rowStartIdxAndCount) {
		return findByProperty(LAST_LAT, lastLat, rowStartIdxAndCount);
	}
